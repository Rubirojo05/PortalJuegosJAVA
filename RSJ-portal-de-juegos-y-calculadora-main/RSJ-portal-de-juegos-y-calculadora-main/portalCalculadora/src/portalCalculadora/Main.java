...
import javax.swing.JFrame;
	...
	public class Main extends JFrame implements Runnable {
		...
		public Main() {
			setBounds(700, 200, SCREEN_WIDTH, SCREEN_HEIGHT);
		...
		public void drawMainMenu() { 
			if(font != null) {
				if(mx >= (SCREEN_WIDTH / 2) - (font.stringWidth("Dificultad: " + difficulty.get(level)) / 2) 
						&& mx <= (SCREEN_WIDTH / 2) + (font.stringWidth("Dificultad: " + difficulty.get(level)) / 2) 
						&& my >= 150 && my <= 240) {
				...
				if(mx >= (SCREEN_WIDTH / 2) - (font.stringWidth("Empezar") / 2) && mx <= (SCREEN_WIDTH / 2) 
						+ (font.stringWidth("Empezar") / 2) && my >= 40 && my <= 100) {
		...
		public void paintComponent(Graphics g) {
			...
			if(state.getState() == 1) {
				...
				g.drawString("Empezar", (SCREEN_WIDTH / 2) - (font.stringWidth("Empezar") / 2), 100);
				
				g.setColor(difficultyHover);
				difficultyCenter = font.stringWidth("Dificultad: " + difficulty.get(level)) / 2;
				g.drawString("Dificultad: " + difficulty.get(level), (SCREEN_WIDTH / 2) - difficultyCenter, 200);
			} else if(state.getState() == 2) {
				g.setColor(Color.black);
				g.fillRect(0, 0, getWidth(), getHeight());
